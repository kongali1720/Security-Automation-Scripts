    ...
    def generate_html(self, filename: str = None) -> str:
        ...
        <head>
            ...
            <style>
                ...
                .header {{ background-color: #2c3e50; color: white; padding: 20px; border-radius: 10px 10px 0 0; margin: -20px -20px 20px -20px; }}
                ...
                .section {{ margin-bottom: 30px; padding: 15px; background-color: #f8f9fa; border-radius: 5px; }}
